...
export default function Movie() {
  ...
  const [movie] = useState({
    ...
    metaDesc: 'Download Smile 2 | 2024 | English With Subtitles | 480p 720p 1080p in HD quality for free.',
    keywords: ['smile', '2', '2024', 'with', 'subtitles'],
    imdbRating: '7.1/10',
    releaseYear: '2024',
    genres: 'Horror, Mystery, Thriller',
    quality: '480p || 720p || 1080p – WEB-DL',
    fileSize: '390MB || 730MB / 1.1GB || 2.8GB',
    language: 'English [Audio]',
    format: 'Mkv',
    director: 'Parker Finn',
    starCast: 'Naomi Scott, Rosemarie DeWitt, Lukas Gage',
    synopsis: 'SMILE 2 — [2024] Paramount Pictures Original Horror Thriller Mystery Drama Psychological R-Rated Film For Free On moviesrock :- Going to set out on another world visit, worldwide pop sensation Skye Riley starts encountering progressively unnerving and illogical occasions. Overpowered by the heightening revulsions and the tensions of distinction, Skye is compelled to confront her dim past to recover control of her life before it twistings crazy.',
    image: 'No image available',
    downloadLinks: [
      {
        type: '480p Links [390MB]',
        link: 'https://ekbiharinews.in/?id=bjd1M0I1YlpuSVJFQ1JJRFM5UFp5S3N6YUR0K09nYTZTOW01UXFaTm9ZSzNyelVmVUhqbCtKbHc0cDVRRlVuOUR0aFpNd1JmdnVJYkZsVWFnc0dkRzdEQm95aHFjdXB0NTNKVklIMklNS009'
      },
      {
        type: '720p HEVC Links [730MB]',
        link: 'https://ekbiharinews.in/?id=bjd1M0I1YlpuSVJFQ1JJRFM5UFp5S3N6YUR0K09nYTZTOW01UXFaTm9ZSzNyelVmVUhqbCtKbHc0cDVRRlVuOVBqeE14NkxpWndYMVlvVVUvTmtRQ291c1dhOGZQbm9ZV1gvbHlzT0NqME09'
      },
      {
        type: '720p Links [1.1GB]',
        link: 'https://ekbiharinews.in/?id=bjd1M0I1YlpuSVJFQ1JJRFM5UFp5S3N6YUR0K09nYTZTOW01UXFaTm9ZSzNyelVmVUhqbCtKbHc0cDVRRlVuOVc1QzFkN2JweEtMa0JsUld6T2pJK01yUldPS1lWSzZTYlJKcTk0WktncXc9'
      },
      {
        type: '1080p Links [2.8GB]',
        link: 'https://ekbiharinews.in/?id=bjd1M0I1YlpuSVJFQ1JJRFM5UFp5S3N6YUR0K09nYTZTOW01UXFaTm9ZSzNyelVmVUhqbCtKbHc0cDVRRlVuOXR3NEExTERveTBTSE5OS0ZXalVJYlZEREFVYUlxOUpMNUtOdzA3SUJ6SHc9'
      }
    ],
    postViews: 5974,
    __v: 0
