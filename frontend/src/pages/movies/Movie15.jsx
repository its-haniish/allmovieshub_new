...
export default function Movie() {
  ...
  const [movie] = useState({
    ...
    metaDesc: 'Download Monster Summer | 2024 | English With Subtitles | 480p 720p 1080p in HD quality for free.',
    keywords: ['monster', 'summer', '2024', 'with', 'subtitles'],
    imdbRating: '5.7/10',
    releaseYear: '2024',
    genres: 'Horror, Mystery',
    quality: '480p || 720p || 1080p – WEB-DL',
    fileSize: '300MB || 800MB || 1.8GB',
    language: 'English',
    format: 'Mkv',
    director: 'David Henrie',
    starCast: 'Mel Gibson, Mason Thames, Julian Lerner',
    synopsis: 'At the point when a strange power starts to disturb their large summer tomfoolery, Noah and his companions collaborate with a resigned police investigator to set out on a tremendous experience to save their island.',
    image: 'No image available',
    downloadLinks: [
      {
        type: '480p Links [300MB]',
        link: 'https://ekbiharinews.in/?id=OENDWVQxZWl2VjVsTVkyaHdjWmNaMDRTQVZabzM5UW1zTFVReFVjVmtGRUlyMDVPSmwvSE9lL3REdGU2aklOMWx1U2crZDN3ME1lRVNmNUl2RGdXY2Q3QjV5T21BY2ZJQ09FU25ydnVBVmM9'
      },
      {
        type: '720p Links [800MB]',
        link: 'https://ekbiharinews.in/?id=OENDWVQxZWl2VjVsTVkyaHdjWmNaMDRTQVZabzM5UW1zTFVReFVjVmtGRUlyMDVPSmwvSE9lL3REdGU2aklOMUZ0NkJMWDhreVA5dGZXTDl1WlI4YTNDSUI1L2xUeDRUV3gwUUxKSDgwMzA9'
      },
      {
        type: '1080p Links [1.8GB]',
        link: 'https://ekbiharinews.in/?id=OENDWVQxZWl2VjVsTVkyaHdjWmNaMDRTQVZabzM5UW1zTFVReFVjVmtGRUlyMDVPSmwvSE9lL3REdGU2aklOMWM3d2x5Q09zN3dNeEdVN3RhU2pYa3RhZVJaaytPcXM2YzI5enpZRlp6c2c9'
      }
    ],
    postViews: 6925,
    __v: 0
