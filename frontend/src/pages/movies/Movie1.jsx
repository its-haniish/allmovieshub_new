...
export default function Movie() {
  ...
  const [movie] = useState({
    ...
    keywords: ['flow', '2024', 'with', 'subtitles'],
    imdbRating: '8.0/10',
    releaseYear: '2024',
    genres: 'Animation, Adventure, Family, Fantasy',
    quality: '480p || 720p || 1080p – WEB-DL',
    fileSize: '700MB || 1.4GB',
    language: 'English',
    format: 'Mkv',
    director: 'Gints Zilbalodis',
    starCast: 'Matiss Kaza, Gints Zilbalodis',
    synopsis: 'Feline is a single creature, yet as its house is crushed by an extraordinary flood, he finds shelter on a boat populated by different species, and should collaborate with them notwithstanding their disparities.',
    image: 'No image available',
    downloadLinks: [
      {
        type: '720p Links [700MB]',
        link: 'https://ekbiharinews.in/?id=MnZMOUtHaG5aSnBUUVo4aUZwK1NhSC9ydGszZjdTejlJeGlqejRtWmhBSzVjYzNRMTZ3Nm1yVjVQcDF6U0M2UnA3a3ZtNWxGSWhpWUhFZmNJRkVPL0FRU3RvT1VUbVBacnhldEVuOTdTcGM9'
      },
      {
        type: '1080p Links [1.4GB]',
        link: 'https://ekbiharinews.in/?id=MnZMOUtHaG5aSnBUUVo4aUZwK1NhSC9ydGszZjdTejlJeGlqejRtWmhBSzVjYzNRMTZ3Nm1yVjVQcDF6U0M2UjFmWVFpa1lSZEZkN0VOc1B0VkMwUEtobno2S1NobjZRM2R0dkpMWUhKa0E9'
      }
    ],
    postViews: 5377,
    __v: 0
