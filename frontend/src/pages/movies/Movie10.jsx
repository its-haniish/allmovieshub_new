...
export default function Movie() {
  ...
  const [movie] = useState({
    ...
    metaDesc: 'Download Entrapment | 1999 | Hindi – English | 480p 720p 1080p in HD quality for free.',
    keywords: ['entrapment', '1999', '–'],
    imdbRating: '6.3/10',
    releaseYear: '1999',
    genres: 'Action, Crime, Romance',
    quality: '480p || 720p || 1080p – BluRay',
    fileSize: '500MB || 800MB / 1GB || 2GB',
    language: 'Hindi DD5.1 + English [Dual Audio Movie]',
    format: 'Mkv',
    director: 'Jon Amiel',
    starCast: 'Sean Connery, Catherine Zeta-Jones, Ving Rhames',
    synopsis: 'Entrapment (1999) Full Movie in Hindi (Dual Audio) [HD For Free On moviesrock] : Protection examiner Virginia Dough puncher considers that the hoodlum Robert MacDougal has burglarized a Rembrandt painting. To recover the composition, she acts like a workmanship cheat, helping out him in criminal demonstrations.',
    image: 'No image available',
    downloadLinks: [
      {
        type: '480p Links [500MB]',
        link: 'https://ekbiharinews.in/?id=QUJuQTJjWjFGWGMvYW9LL1piRlMrMHpOQW9mMlNYZUFWZVg3ckM4bGJTTEZDZDF1QVV6VVVVM3dzRVU0cWp3VU1LdXdkekc5Uk5qNzJGRzRqcXF3VEpQRlZYSDRDOXp4bVRJYTFwVnJvRmM9'
      },
      {
        type: '720p HEVC Links [800MB]',
        link: 'https://ekbiharinews.in/?id=QUJuQTJjWjFGWGMvYW9LL1piRlMrMHpOQW9mMlNYZUFWZVg3ckM4bGJTTEZDZDF1QVV6VVVVM3dzRVU0cWp3VXp2NXcxWEtNUzZtWFB4SXpJUUZCMmlhMTZFMlNlMHRpUEROdHZwWXBMTXM9'
      },
      {
        type: '720p Links [1GB]',
        link: 'https://ekbiharinews.in/?id=QUJuQTJjWjFGWGMvYW9LL1piRlMrMHpOQW9mMlNYZUFWZVg3ckM4bGJTTEZDZDF1QVV6VVVVM3dzRVU0cWp3VThaNEhQelFSalNNb3hyUk9OMElHSlE2eURPNWk4cjNET3hZTjlIWTlwV0k9'
      },
      {
        type: '1080p Links [2GB]',
        link: 'https://ekbiharinews.in/?id=QUJuQTJjWjFGWGMvYW9LL1piRlMrMHpOQW9mMlNYZUFWZVg3ckM4bGJTTEZDZDF1QVV6VVVVM3dzRVU0cWp3VUYwNldpY1JrYmhPVnNIbUZGUzR0VldGVlhheGhyWldLcGxoSFMwVm91Y0U9'
      }
    ],
    postViews: 1525,
    __v: 0
