...
export default function Movie() {
  ...
  const [movie] = useState({
    ...
    metaDesc: 'Download Abbara | 2022 | Hindi-Kannada | 480p 720p 1080p in HD quality for free.',
    keywords: ['abbara', '2022', 'hindi-kannada'],
    imdbRating: '6.1/10',
    releaseYear: '2022',
    genres: 'Action',
    quality: '480p || 720p || 1080p – WEB-DL',
    fileSize: '500MB || 1.4GB || 3GB',
    language: 'Dual Audio [Hindi ORG + Kannada]',
    format: 'Mkv',
    director: 'K. Ramnarayan',
    starCast: 'Lekha Chandra, Prajwal Devaraj, Vaibhav Gohil',
    synopsis: 'No synopsis available',
    image: 'https://moviesrock.blog/wp-content/uploads/2024/11/5dgEsdvgsdgdfvgdgfdvz.webp',
    downloadLinks: [
      {
        type: '480p Links [500MB]',
        link: 'https://ekbiharinews.in/?id=VTd0cm5iUHhXbDhpSzRIUlpxekJteTZQd01SYmhlbUlNcVZtVkQ5THFBYzFRSHFyUEdZTm1hQ1V1VnBwNWtpVXh1RkhRWGs1a25iVnQxZDcvcWtGL2JZNGFoZ0JjSGFqWEdCSjJzR2pGM0k9'
      },
      {
        type: '720p Links [1.4GB]',
        link: 'https://ekbiharinews.in/?id=VTd0cm5iUHhXbDhpSzRIUlpxekJteTZQd01SYmhlbUlNcVZtVkQ5THFBYzFRSHFyUEdZTm1hQ1V1VnBwNWtpVWNZVkdaQ0JwTXlOY04zRDgzOURYczlGY0grRzAvdXZDK1dTZ1cySUNQSFk9'
      },
      {
        type: '1080p Links [3GB]',
        link: 'https://ekbiharinews.in/?id=VTd0cm5iUHhXbDhpSzRIUlpxekJteTZQd01SYmhlbUlNcVZtVkQ5THFBYzFRSHFyUEdZTm1hQ1V1VnBwNWtpVVZxbUkvb0dCRm1iTEoyWmg3aVc0ejhhQ25mbDNPKytLK1hIdzYzRDAwLzg9'
      }
    ],
    postViews: 7876,
    __v: 0
