...
export default function Movie() {
  ...
  const [movie] = useState({
    ...
    metaDesc: 'Download Goodrich | 2024 | English With Subtitles | 480p 720p 1080p in HD quality for free.',
    keywords: ['goodrich', '2024', 'with', 'subtitles'],
    imdbRating: '6.3/10',
    releaseYear: '2024',
    genres: 'Comedy, Drama',
    quality: '480p || 720p || 1080p – WEB-DL',
    fileSize: '330MB || 900MB || 2.1GB',
    language: 'English',
    format: 'Mkv',
    director: 'Hallie Meyers-Shyer',
    starCast: 'Michael Keaton, Mila Kunis, Danny Deferrari',
    synopsis: 'Andy Goodrich’s life is overturned when his better half enters a recovery program, leaving him all alone with their small children. Goodrich rests on Beauty, his little girl from his most memorable marriage, as he at last develops into the dad she won’t ever have.',
    image: 'No image available',
    downloadLinks: [
      {
        type: '480p Links [330MB]',
        link: 'https://ekbiharinews.in/?id=VWREcU1CdFNoeEErR0l3UFZ1TG41WjBOclE1b2w1SzZXRFBWeGdPdlR5SFR4bjRBOWdPK1dlblJETnlOQVFSZSsxTVNCdEVFSTlpZGQxWGFwRzNRQzNQNjFEdmN5NDg1TmtzRUhuNkkwRzg9'
      },
      {
        type: '720p Links [900MB]',
        link: 'https://ekbiharinews.in/?id=VWREcU1CdFNoeEErR0l3UFZ1TG41WjBOclE1b2w1SzZXRFBWeGdPdlR5SFR4bjRBOWdPK1dlblJETnlOQVFSZVcvUGhzVUQxR2dMRmJHekpTNUZkdExwUVBmaUtzTFRQdmh3WjRKWmpUODg9'
      },
      {
        type: '1080p Links [2.1GB]',
        link: 'https://ekbiharinews.in/?id=VWREcU1CdFNoeEErR0l3UFZ1TG41WjBOclE1b2w1SzZXRFBWeGdPdlR5SFR4bjRBOWdPK1dlblJETnlOQVFSZWgzbEw4bVRUcWJxZVgwamdhNGE1Mm5ZUElYUkNEdmd3d3hDSVJJczhxaUE9'
      }
    ],
    postViews: 2240,
    __v: 0
