...
export default function Movie() {
  ...
  const [movie] = useState({
    ...
    metaDesc: 'Download Black Cab | 2024 | English With Subtitles | 480p 720p 1080p in HD quality for free.',
    keywords: ['black', 'cab', '2024', 'with', 'subtitles'],
    imdbRating: '4.1/10',
    releaseYear: '2024',
    genres: 'Thriller',
    quality: '480p || 720p || 1080p – WEB-DL',
    fileSize: '250MB || 700MB || 1.7GB',
    language: 'English',
    format: 'Mkv',
    director: 'Bruce Goodison',
    starCast: 'George Bukhari, Nick Frost, Synnove Karlsen',
    synopsis: 'A couple who find their happy taxi driver redirects them to a remote, tormented street, uncovering upsetting thought processes and his actual expectations.',
    image: 'https://moviesrock.blog/wp-content/uploads/2024/11/STGHSDHSFHSGFHSFJGHFJG.webp',
    downloadLinks: [
      {
        type: '480p Links [250MB]',
        link: 'https://ekbiharinews.in/?id=SEN6WnBzbnRRcU9CNEJ6aHdnQ2ZvM0tlQndXYjVLWTErZFdhRFRKQmlJZDQwQUM0NW9mdDRDOG5LcTJMVVUwQ2F4ZC80NHZOc01zVDN4S1UyUkMwdW9vT3MycFNWMUFlRDRFdGtxeW5DaTg9'
      },
      {
        type: '720p Links [700MB]',
        link: 'https://ekbiharinews.in/?id=SEN6WnBzbnRRcU9CNEJ6aHdnQ2ZvM0tlQndXYjVLWTErZFdhRFRKQmlJZDQwQUM0NW9mdDRDOG5LcTJMVVUwQ3lJdUZPS0ZVem94QkIvZUR5UEtteXJ3Uld6ajdUY1VNOWUwTnlmTTJBenM9'
      },
      {
        type: '1080p Links [1.7GB]',
        link: 'https://ekbiharinews.in/?id=SEN6WnBzbnRRcU9CNEJ6aHdnQ2ZvM0tlQndXYjVLWTErZFdhRFRKQmlJZDQwQUM0NW9mdDRDOG5LcTJMVVUwQ0xFRGJiTU1JZUo0Uk9Udy9qSmtDSVRaTCtRYXZ0RDdzbllPdzFEYThCUnc9'
      }
    ],
    postViews: 8369,
    __v: 0
